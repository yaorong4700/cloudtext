...
<script language="javascript">
	function changetext() {
		...
		var file = document.getElementById("LoadingSource");
		myDiv.innerText = "${username }镜像创建成功";
	}
</script>
<body
	...
	<div id="container" class="container">
		...
		<div id="menu" class="menu">
			<br> <a
				...
				style="top: 1; position: relative;"><img src="pic/Pcoder.png" /><br>代码构建</a><br>
			<br> <a href="upload?username=${username}&usermail=${usermail}"
				...
				src="pic/bell.png" /><br>应用列表</a><br><br>
				   <a href="servicelist?username=${username}&usermail=${usermail}" title="服务列表" style="top:4;position: relative;"><img src="pic/app.png"/><br>服务列表</a><br> 
